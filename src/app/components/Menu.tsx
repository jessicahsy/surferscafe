...
export function Menu({
    ...
    return (
      <div
        ...
        className={`group relative flex cursor-pointer flex-col overflow-hidden rounded-3xl border bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${
          quantity > 0
            ? 'border-[#d79a4a] bg-[#fff4e6] ring-2 ring-[#d79a4a]/20 shadow-md'
            : 'border-stone-200'
        }`}
      >
        ...
        <div className="flex flex-1 flex-col p-4">
          ...
          <div className="mt-auto">{null}</div>
        </div>
      </div>
    );
  };
  ...
  const categories: MenuCategory[] = ['飲品', '食品', '商品'];
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="flex h-9 w-9 items-center justify-center rounded-2xl border border-stone-200 bg-stone-50 text-stone-700 transition hover:bg-stone-100"
                          >
                            <Minus className="h-4 w-4" />
                          </button>

                          <div className="h-9 min-w-[44px] items-center justify-center rounded-2xl border border-stone-200 bg-white px-3 text-center text-lg font-semibold text-stone-900 flex">
                            {item.quantity}
                          </div>
